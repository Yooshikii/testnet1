...
impl PruningProofManager {
    ...
    pub(crate) fn calculate_pruning_point_anticone_and_trusted_data(
        ...
        // [Starlight]: get ghostdag k based on the pruning point's DAA score. The off-by-one of not going by selected parent
    ...
    pub fn get_pruning_point_anticone_and_trusted_data(&self) -> ConsensusResult<Arc<PruningPointTrustedData>> {
        ...
        // [Starlight]: use pruning point DAA score for activation. This means that only after sufficient time
