...
pub struct HeaderProcessingContext {
    ...
    pub selected_parent_daa_score: Option<u64>, // [Starlight]
...
pub struct HeaderProcessor {
    ...
    pub(super) starlight_activation: ForkActivation,
...
impl HeaderProcessor {
    ...
    fn validate_header(&self, header: &Arc<Header>) -> BlockProcessResult<HeaderProcessingContext> {
        ...
        // [Starlight]: persist the selected parent DAA score to be used for activation checks
