...
use super::{
    ...
    utxo_validation::starlight::StarlightLogger,
};
...
pub struct VirtualStateProcessor {
    ...
    pub(super) starlight_logger: StarlightLogger,

    // Starlight hardfork activation score (used here for activating KIPs 9,10)
...
impl VirtualStateProcessor {
    ...
    pub(crate) fn build_block_template_from_virtual_state(
        ...
        let storage_mass_activated = self.starlight_activation.is_active(virtual_state.daa_score);
