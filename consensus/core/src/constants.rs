...
/// VeniPerVecno is the number of veni in one vecno (1 VE).
pub const VENI_PER_VECNO: u64 = 100_000_000;

/// The parameter for scaling inverse VE value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = VENI_PER_VECNO * 10_000;
...
/// maxVeni is the maximum transaction amount allowed in veni.
pub const MAX_VENI: u64 = 20_000_000_000 * VENI_PER_VECNO;
